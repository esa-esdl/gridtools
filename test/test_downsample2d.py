...
class Downsample2dTest(unittest.TestCase):
    def _test_downsample2d(self, src, out_w, out_h, method, fill_value, desired):
    ...
    def test_no_op(self):
        self._test_downsample2d([[1., 2.], [3., 4.]], 2, 2, gtr.DS_MEAN, -1., [[1., 2.], [3., 4.]])

    def test_aggregation_mean(self):
        self._test_downsample2d([[0.6, 0.2, 3.4],
                                 [1.4, 1.6, 1.0],
                                 [4.0, 2.8, 3.0]],
                                2, 2, gtr.DS_MEAN, -1.,
        ...
        self._test_downsample2d([[0.9, 0.5, 3.0, 4.0],
                                 [1.1, 1.5, 1.0, 2.0],
                                 [4.0, 2.1, 3.0, 5.0],
                                 [3.0, 4.9, 3.0, 1.0]],
                                2, 2, gtr.DS_MEAN, -1.,
        ...
        self._test_downsample2d([[NAN, NAN, 3.0, 4.0],
                                 [NAN, NAN, 1.0, 2.0],
                                 [4.0, 2.1, 3.0, NAN],
                                 [3.0, 4.9, NAN, 1.0]],
                                2, 2, gtr.DS_MEAN, -1.,
    ...
    def test_aggregation_mean_masked(self):
        self._test_downsample2d(np.ma.array([[0.9, 0.5, 3.0, 4.0],
                                              [1.1, NAN, 1.0, 2.0],
                                              [4.0, 2.1, 3.0, 5.0],
                                              [3.0, 4.9, NAN, 1.0]],
                                             mask=[[1, 1, 0, 0],
    ...
    def test_aggregation_mode(self):
        ...
        self._test_downsample2d([[3, 5, 2, 1],
                                 [3, 5, 4, 3],
                                 [1, 1, 3, 4],
                                 [4, 1, 4, 4]],
                                2, 2, gtr.DS_MODE, 0,
    ...
    def test_aggregation_mode_masked(self):
        ...
        self._test_downsample2d(np.ma.array([[3, 5, 2, 1],
                                             [3, 5, 4, 3],
                                             [1, 1, 3, 4],
                                             [4, 1, 4, 4]],
                                            mask=[[0, 0, 1, 1],
