...
class Resample2dTest(unittest.TestCase):
    ...
    def test_no_op(self):
        _test_resample2d(SRC,
                         4, 4, gt.resample.DS_FIRST, gt.resample.US_NEAREST,
                         SRC)

    def test_aggregate_w(self):
        _test_resample2d(SRC,
                         2, 4, gt.resample.DS_FIRST, gt.resample.US_NEAREST,
                         [[0.9, 3.],
                          [1.1, 1.],
                          [4., 3.],
                          [3., 3.]])
    ...
    def test_aggregate_w_aggregate_h(self):
        _test_resample2d(SRC,
                         2, 2, gt.resample.DS_MEAN, gt.resample.US_NEAREST,
                         [[1.0, 2.5],
                          [3.5, 3.0]])

    def test_aggregate_w_interpolate_h(self):
        _test_resample2d(SRC,
                         2, 8, gt.resample.DS_FIRST, gt.resample.US_NEAREST,
                         [[0.9, 3.],
                          [0.9, 3.],
                          [1.1, 1.],
                          [1.1, 1.],
    ...
    def test_aggregate_h(self):
        _test_resample2d(SRC,
                         4, 2, gt.resample.DS_FIRST, gt.resample.US_NEAREST,
                         [[0.9, 0.5, 3., 4.],
                          [4., 2.1, 3., 5.]])

    def test_interpolate_w(self):
        _test_resample2d(SRC,
                         8, 4, gt.resample.DS_MEAN, gt.resample.US_NEAREST,
    ...
    def test__interpolate_w_interpolate_h(self):
        _test_resample2d(SRC,
                         8, 8, gt.resample.DS_MEAN, gt.resample.US_NEAREST,
                         [[0.9, 0.9, 0.5, 0.5, 3., 3., 4., 4.],
                          [0.9, 0.9, 0.5, 0.5, 3., 3., 4., 4.],
                          [1.1, 1.1, 1.5, 1.5, 1., 1., 2., 2.],
                          [1.1, 1.1, 1.5, 1.5, 1., 1., 2., 2.],
    ...
    def test__interpol_w_aggregate_h(self):
        _test_resample2d(SRC,
                         8, 2, gt.resample.DS_MEAN, gt.resample.US_NEAREST,
                         [[1., 1., 1., 1., 2., 2., 3., 3.],
